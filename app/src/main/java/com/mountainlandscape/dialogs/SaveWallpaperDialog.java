...
public class SaveWallpaperDialog {
    ...
    public static void showDialog(final Context context, final SaveWallpaperDialogEvents callback) {
    ...
    public interface SaveWallpaperDialogEvents {
