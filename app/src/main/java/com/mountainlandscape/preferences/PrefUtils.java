package com.mountainlandscape.preferences;
...
public class PrefUtils {
    ...
    public static void save(Context context, String key, double value) {
        getPrefs(context).edit().putLong(key, Double.doubleToRawLongBits(value)).apply();
    }
    ...
    public static ObscuredSharedPreferences getPrefs(Context context) {
        return new ObscuredSharedPreferences(context, context.getSharedPreferences("wallpaper_prefs", Context.MODE_PRIVATE));
    }
